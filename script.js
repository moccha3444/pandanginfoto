...
*/
  ...
  function AnimasiTeks(){
  	...
  	new TypeIt("#textsec2", {
      strings: ["" + ID_AnimasiTeks], startDelay: 100, speed: 40, /* deff 55 */ cursor: false,
  ...
  function AnimasiTeks2(){
  	...
  	scrollContainer.style="transform: scale(1)";
  	new TypeIt("#textsec3", {
      strings: ["" + ID_AnimasiTeks2], startDelay: 200, speed: 40, /* deff 55 */ cursor: false,
      afterComplete: function(){
          ...
          setTimeout(function() {
            textsec3.style = "transform:scale(0);transition:all .7s ease;margin-left:0;margin-right:0";
            setTimeout(function() {
              textsec3.style = "transform:scale(.85);transition:all .7s ease;margin-left:0;margin-right:0";
              textsec3.innerHTML = textsec3b.innerHTML;
...
function menuju(){window.location = "https://api.whatsapp.com/send/?phone=6282178397902&text=" + pesanwhatsapp;}
